...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'console_command.close_account' => 'getConsoleCommand_CloseAccountService',
            'console_command.deposit_fund' => 'getConsoleCommand_DepositFundService',
            'console_command.display_balance' => 'getConsoleCommand_DisplayBalanceService',
            'console_command.open_account' => 'getConsoleCommand_OpenAccountService',
            'console_command.withdraw_fund' => 'getConsoleCommand_WithdrawFundService',
        ...
        $this->aliases = array(
            ...
            'console.command.appbundle_command_closeaccountcommand' => 'console_command.close_account',
            'console.command.appbundle_command_depositfundcommand' => 'console_command.deposit_fund',
            'console.command.appbundle_command_displaybalancecommand' => 'console_command.display_balance',
            'console.command.appbundle_command_openaccountcommand' => 'console_command.open_account',
            'console.command.appbundle_command_withdrawfundcommand' => 'console_command.withdraw_fund',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5a2L-2pBOP', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4V5PRlvZgJ', 0, 'JrdFdNlp+6LiEtFn3R18XS', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the public 'console_command.close_account' shared service.
     *
     * @return \AppBundle\Command\CloseAccountCommand
     */
    protected function getConsoleCommand_CloseAccountService()
    {
        return $this->services['console_command.close_account'] = new \AppBundle\Command\CloseAccountCommand($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'console_command.deposit_fund' shared service.
     *
     * @return \AppBundle\Command\DepositFundCommand
     */
    protected function getConsoleCommand_DepositFundService()
    {
        return $this->services['console_command.deposit_fund'] = new \AppBundle\Command\DepositFundCommand($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'console_command.display_balance' shared service.
     *
     * @return \AppBundle\Command\DisplayBalanceCommand
     */
    protected function getConsoleCommand_DisplayBalanceService()
    {
        return $this->services['console_command.display_balance'] = new \AppBundle\Command\DisplayBalanceCommand($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'console_command.open_account' shared service.
     *
     * @return \AppBundle\Command\OpenAccountCommand
     */
    protected function getConsoleCommand_OpenAccountService()
    {
        return $this->services['console_command.open_account'] = new \AppBundle\Command\OpenAccountCommand($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'console_command.withdraw_fund' shared service.
     *
     * @return \AppBundle\Command\WithdrawFundCommand
     */
    protected function getConsoleCommand_WithdrawFundService()
    {
        return $this->services['console_command.withdraw_fund'] = new \AppBundle\Command\WithdrawFundCommand($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'bank_project', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0cc2b4acc6a509ea449ac5b473398e3fcabd38b762a53603d12589bfdd287738');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('nosecret');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JzjmSSAMbA', 0, 'JrdFdNlp+6LiEtFn3R18XS', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('598ea1e5350d54.19861237')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'console.command.ids' => array(
                0 => 'console_command.open_account',
                1 => 'console_command.deposit_fund',
                2 => 'console_command.withdraw_fund',
                3 => 'console_command.display_balance',
                4 => 'console_command.close_account',
